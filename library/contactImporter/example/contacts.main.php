<?php
include_once LIB_DIR.'contactImporter/Svetlozar.NET/init.php';
...
class ContactsHandler
{
	...
	function __construct($output_page = true, $redirect_expected = false)
	{
		...
		$query_parms = array_diff_key($GLOBALS['GET'], array(self::$contacts_option => ""));
	...
	function handle_request($post = null)
	{
		...
		$selected_option = isset($GLOBALS['GET'][self::$contacts_option]) ? $GLOBALS['GET'][self::$contacts_option] : self::$default_class;
