        ...
        <div class="content">
            ...
            <?php if ($this->display_menu) { ?>
                ...
                <ul id="menu">
                    ...
                    <li><a href="<?php echo 'http://'.DOMAIN.DS.Config::get('app').'/'.Config::get('module').'/'.Config::get('action')."/contacts_option/".$k; ?>"><?php echo $v->ClassName . ($v->ExternalAuth ? "<br/>(External Authentication)" : ""); ?></a></li>
                    <?php } ?>
                </ul>
            <?php } ?>
            <div class="clear">&nbsp;</div>
